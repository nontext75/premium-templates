        ...
        <main className="bg-brand-primary min-h-screen flex items-center justify-center pt-20">
            <div className="architectural-grid w-full">
                <div className="col-span-12 lg:col-span-4 lg:start-5">
                    ...
                    >
                        <div className="mb-12">
                            <span className="text-[10px] font-black text-[#7d5fff] tracking-[0.5em] block mb-4 uppercase">New Residency Application</span>
                            <h1 className="text-4xl font-sans font-black text-white uppercase tracking-tighter">Join The <br /> Collective.</h1>
                        </div>

                        <form className="space-y-8">
                            <div>
                                <label className="text-[9px] font-black uppercase tracking-[0.3em] text-white/40 block mb-3">Full Name</label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label className="text-[9px] font-black uppercase tracking-[0.3em] text-white/40 block mb-3">Password</label>
                                <input
                                    type="password"
                                    className="w-full bg-transparent border-b border-white/20 py-4 text-white font-sans focus:border-[#7d5fff] outline-none transition-colors"
                                    placeholder="••••••••"
                        ...
                        <div className="mt-12 text-center text-[9px] font-black uppercase tracking-[0.2em]">
                            <span className="text-white/40">Already have access? </span>
                            <Link href="/login" className="text-white hover:text-[#7d5fff] transition-colors ml-2">Sign In</Link>
                        </div>
                    </motion.div>
                </div>
            </div>
