...
const projects = [
    ...
    },
    {
        ...
        category: 'Ver. Ka',
        year: '2023',
        image: '/images/gundam-sazabi.jpg'
    },
    {
        id: 'unicorn',
        title: 'RX-0 Unicorn',
        ...
        year: '2023',
        image: '/images/gundam-unicorn.jpg'
    }
];
        ...
        <section className="bg-brand-primary py-32 text-brand-secondary">
            <div className="architectural-grid mb-24">
                <div className="col-span-12 flex items-end justify-between">
                    <h2 className="text-monumental text-white text-[8vw]">Selected <br /> Works</h2>
                        ...
                        >
                            ...
                            <div className="col-span-12 md:col-span-4 flex flex-col justify-between py-2 border-t border-brand-secondary/20 md:border-t-0">
                                <div>
                                    ...
                                    <h3 className="font-space font-bold text-3xl md:text-4xl text-white mb-4">{project.title}</h3>
