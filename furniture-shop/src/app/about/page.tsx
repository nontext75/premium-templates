            ...
            <div className="architectural-grid">
                <div className="col-span-12 md:col-span-6 space-y-12">
                    ...
                    >
                        ...
                        <h1 className="font-space font-black text-[8vw] leading-none uppercase mt-8">
                            Our <br /> Legacy.
                        </h1>
                    </motion.div>
                </div>
            ...
            <section className="mt-40 border-y border-black/5 py-32">
                <div className="architectural-grid">
                    <div className="col-span-12 md:col-span-4 space-y-6">
                        ...
                        <h3 className="font-space font-bold text-3xl uppercase">The Human Touch</h3>
                    ...
                    <div className="col-span-12 md:col-span-4 space-y-6 border-l border-black/5 pl-8">
                        ...
                        <h3 className="font-space font-bold text-3xl uppercase">Earth First</h3>
                    ...
                    <div className="col-span-12 md:col-span-4 space-y-6 border-l border-black/5 pl-8">
                        ...
                        <h3 className="font-space font-bold text-3xl uppercase">Future Built</h3>
